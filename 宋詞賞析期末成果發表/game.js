    ...
    drawScore : function() {
        ...
        switch (state.curr) {
            ...
            case state.gameOver :
                    sctx.lineWidth = "2";
                    sctx.font = "30px 標楷體";
                    let sc = `分數 : ${this.score.curr}`;
                    try {
                        this.score.best = Math.max(this.score.curr,localStorage.getItem("紀錄"));
                        localStorage.setItem("紀錄",this.score.best);
                        let bs = `紀錄 : ${this.score.best}`;
...
bird.animations[0].sprite.src="img/bird/BB1.png";
bird.animations[1].sprite.src="img/bird/BB2.png";
bird.animations[2].sprite.src="img/bird/BB2.png";
bird.animations[3].sprite.src="img/bird/BB1.png";
